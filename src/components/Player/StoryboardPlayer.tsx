            ...
            {currentSegmentIndex >= 0 && (
                <div className="absolute bottom-4 left-4 font-mono text-xs bg-black/70 text-neon-purple px-3 py-1 rounded-full backdrop-blur-sm flex items-center gap-2">
                    <span
                        ...
                        style={{ backgroundColor: segments[currentSegmentIndex]?.color || '#8b5cf6' }}
                    />
            ...
            {currentSegmentIndex >= 0 && (
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-white/10">
                    <div
                        ...
                        style={{
                            width: `${((currentTime - segments[currentSegmentIndex].start) /
                                    (segments[currentSegmentIndex].end - segments[currentSegmentIndex].start)) * 100
                                }%`,
                            backgroundColor: segments[currentSegmentIndex]?.color || '#8b5cf6'
                        }}
                    />
                </div>
            )}
